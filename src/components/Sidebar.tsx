  ...
  return (
    <aside className="hidden md:flex h-screen bg-sidebar border-r border-sidebar-border flex-col overflow-hidden">
      ...
      <div className="p-6 flex-shrink-0">
        {!collapsed && <img src={gruttoLogo} alt="Grutto" className="h-8 w-auto" />}
        {collapsed && <div className="w-8 h-8 bg-primary rounded-lg"></div>}
      </div>
